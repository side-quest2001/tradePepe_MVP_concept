...
journalRouter.post("/order-groups/:id/publish", createRateLimitMiddleware({ keyPrefix: "group-publish", maxRequests: 20 }), publishOrderGroup);
journalRouter.patch("/order-groups/:id/publish", createRateLimitMiddleware({ keyPrefix: "group-publish-patch", maxRequests: 20 }), patchPublishedOrderGroup);
